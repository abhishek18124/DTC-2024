...
int main() {
	...
	// unordered_map<string, double> foodMap;
	// unordered_map<string, int> phoneMap;
	// unordered_map<string, vector<int>> phoneMap2;
	...
	cout << "size : " << capitalMap.size() << endl; // currently map has two key-value pairs
	...
	capitalMap.empty() ? cout << "map is empty" << endl : cout << "map is non-empty" << endl;
